...
<head>
  <!-- Metas -->
  <meta charset="utf-8">
  <title>Portfolio - Aditya Verma</title>
  ...
  <div id="wrapper">
    ...
    <section id="home" class="home">
      ...
      <div class="block-content ">
        <div class="block-teaser block-background-image large overlay" data-background="{{Request::root()}}/assets/img/teaser/1.jpg">
          <!--Container-->
          <div class="container ">
            <!--Row-->
            <div class="row">
              <div class="col-sm-12 ">
                <h1 class="white ">Aditya Verma</h1>
                <h3 class="mt-20 white mb-200">Web Designer / Developer</h3>
              </div>
            </div>
            <!--End row-->
            <!--Row-->
            <div class="row">
              <div class="col-sm-6 ">
                <a href="#" class="but opc ico white"><i class="icon-print-1"></i>Print Out My CV</a>
              </div>
              <div class="col-sm-6 t-right">
                <p class="white short-email">Do you have any questions ? Write to me at <a href="mailto:ghribbenaissa@gmail.com">adityaverma2010@gmail.com</a> </p>
              </div>
            </div>
            <!--End row-->
          </div>
        ...
        <div class="container ">
          ...
          <div class="row">
            <div class="col-sm-5 t-center">
              <ul class="menu first">
                <li><a 	class="scroll" href="#home">Home<i class="icon-home"></i></a></li>
                <li><a  class="scroll" href="#about">About<i class="icon-user"></i></a></li>
                <li><a  class="scroll" href="#resume">Resume<i class="icon-doc-text-inv"></i></a></li>
              </ul>
            </div>
            ...
            <div class="col-sm-5 t-center">
              <ul class="menu second">
                <li><a class="scroll" href="#portfolio">Portfolio<i class="icon-camera"></i></a></li>
                <li><a  class="scroll" href="#blog">Blog<i class="icon-chat"></i></a></li>
                <li><a  class="scroll" href="#contact">Contact<i class="icon-paper-plane"></i></a></li>
              </ul>
            </div>
          </div>
          <!--End row-->
    ...
    <section id="about" class="about">
      ...
      <div class="block-content clearfix">
        <div class="block-about one bg-grey-1 ">
          ...
          <h5 class="lead mt-40">A Talented Web Designer / Developer Located In Our Lovely Earth</h5>
          <p class="mt-20">Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
          ...
          <div class="block-about two bg-grey-2 ">
            ...
            <ul class="mt-40 info">
              <li><span>Birthdate</span> : 05/03/1992</li>
              <li><span>Phone</span> : + 91-8285031215</li>
              <li><span>Email</span> : adityaverma2010@hotmail.com</li>
              <li><span>Skype</span> : adityaverma2010 </li>
              <li><span>Freelance</span> : Available</li>
              <li><span>Adresse</span> : H-236, SEC-44, Street No.- 3, Noida, IN 201 305.</li>
            </ul>
      ...
      <section id="resume" class="resume pt-100 pb-80">
                  ...
                  <div class="timeline mt-40">
                    <div class="exp">
                      <div class="hgroup mb-5">
                        ...
                        <h6>Feb 2015 &ndash; <span class="current">Current</span></h6>
                      </div>
              ...
              <div class="col-md-4 col-sm-6 resume-boxe masonry">
                <div class="inner-resume-boxe">
                  ...
                  <div class="timeline mt-40">
                    <div class="edu">
                      <div class="hgroup mb-5">
                        <h4>Bachelor Degree &ndash; Mutation Media </h4>
                        <h6>Feb 2015 &ndash; Nov 2015</h6>
                      </div>
                      <p>Ut enim ad minim veniam, quis nostrud exerc, irure dolor in reprehend.
                      </p>
                    </div>
                    <div class="edu">
                      <div class="hgroup mb-5">
                        <h4>Master Degree &ndash; Mutation Media  </h4>
                        <h6>Sept 2015 &ndash; Nov 2015</h6>
                      </div>
                      <p>Ut enim ad minim veniam, quis nostrud exerc, irure dolor in reprehend.
                      </p>
                    ...
                    <div class="edu">
                      <div class="hgroup mb-5">
                        <h4>School Of Science &ndash; Mutation Media  </h4>
                        <h6>May 2015 &ndash; Sept 2015</h6>
                      </div>
                      <p>Ut enim ad minim veniam, quis nostrud exerc, irure dolor in reprehend.
                      </p>
                    </div>
                ...
                <div class="inner-resume-boxe">
                  ...
                  <div class="hb-list mt-40 ">
                    <ul>
                      ...
                      <li>
                        <span><i class="ic-strategy"></i></span>
                        <h6>Gaming</h6>
                      </li>
                      <li>
        ...
        <!--End block content-->
        <!--Block content-->
        <div class="block-content t-center block-background-image medium overlay" data-background="img/parallax/5.jpg">
          <div class="block-testi ">
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <!--Blog section-->
                <section id="blog" class="blog pt-100">
                  <!--Block content-->
                  <div class="block-content">
                    <!--Container-->
                    <div class="container ">
                                ...
                                <div class="col-sm-4">
                                  <div class="block-info">
                                    ...
                                    <div class="info-det">
                                      ...
                                      <p>Office : + 123-456-789-456<br>
                                        Cell : + 126-156-489-756</p>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-sm-4">
                                    <div class="block-info">
                                      ...
                                      <div class="info-det">
                                        ...
                                        <p>1234 Street Road<br> City Name, IN 567 890.</p>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-sm-4">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <ul class="socials round pb-20">
                                  <li><a href="#"><i class="icon-facebook-circled"></i><span>Facebook</span></a></li>
                                  <li><a href="#"><i class="icon-twitter-circled"></i><span>Twitter</span></a></li>
                                  <li><a href="#"><i class="icon-linkedin-circled"></i><span>Linkedin</span></a></li>
                                  <li><a href="#"><i class="icon-dribbble-circled"></i><span>Dribbble</span></a></li>
                                </ul>
                                <hr>
                                <p class="pt-20">&copy; 2016 all rights reserved. A product of <a href="http://www.mutationmedia.net" target="_blank">Mutationthemes</a>.</p>
                              </div>
                            </div>
                            <!--End row-->
                          </div>
